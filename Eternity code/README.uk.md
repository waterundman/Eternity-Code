...
# Менеджери пакетів
npm i -g eternity-code-ai@latest        # або bun/pnpm/yarn
scoop install eternity-code             # Windows
choco install eternity-code             # Windows
brew install anomalyco/tap/eternity-code # macOS і Linux (рекомендовано, завжди актуально)
brew install eternity-code              # macOS і Linux (офіційна формула Homebrew, оновлюється рідше)
sudo pacman -S eternity-code            # Arch Linux (Stable)
paru -S eternity-code-bin               # Arch Linux (Latest from AUR)
mise use -g eternity-code               # Будь-яка ОС
nix run nixpkgs#eternity-code           # або github:anomalyco/eternity-code для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/anomalyco/eternity-code/releases) або [eternity-code.ai/download](https://eternity-code.ai/download).
...
4. `$HOME/.eternity-code/bin` - Резервний варіант за замовчуванням
...
Дізнайтеся більше про [agents](https://eternity-code.ai/docs/agents).

### Документація

Щоб дізнатися більше про налаштування OpenCode, [**перейдіть до нашої документації**](https://eternity-code.ai/docs).
...
Якщо ви працюєте над проєктом, пов'язаним з OpenCode, і використовуєте "eternity-code" у назві, наприклад "eternity-code-dashboard" або "eternity-code-mobile", додайте примітку до свого README.
...
**Приєднуйтеся до нашої спільноти** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
