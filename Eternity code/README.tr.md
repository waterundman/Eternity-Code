...
# Paket yöneticileri
npm i -g eternity-code-ai@latest        # veya bun/pnpm/yarn
scoop install eternity-code             # Windows
choco install eternity-code             # Windows
brew install anomalyco/tap/eternity-code # macOS ve Linux (önerilir, her zaman güncel)
brew install eternity-code              # macOS ve Linux (resmi brew formülü, daha az güncellenir)
sudo pacman -S eternity-code            # Arch Linux (Stable)
paru -S eternity-code-bin               # Arch Linux (Latest from AUR)
mise use -g eternity-code               # Tüm işletim sistemleri
nix run nixpkgs#eternity-code           # veya en güncel geliştirme dalı için github:anomalyco/eternity-code
```
...
OpenCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/anomalyco/eternity-code/releases) veya [eternity-code.ai/download](https://eternity-code.ai/download) adresinden indirebilirsiniz.
...
4. `$HOME/.eternity-code/bin` - Varsayılan yedek konum
...
[Ajanlar](https://eternity-code.ai/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

OpenCode'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://eternity-code.ai/docs).
...
OpenCode ile ilgili bir proje üzerinde çalışıyorsanız ve projenizin adının bir parçası olarak "eternity-code" kullanıyorsanız (örneğin, "eternity-code-dashboard" veya "eternity-code-mobile"), lütfen README dosyanıza projenin OpenCode ekibi tarafından geliştirilmediğini ve bizimle hiçbir şekilde bağlantılı olmadığını belirten bir not ekleyin.
...
**Topluluğumuza katılın** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
