...
npm i -g eternity-code-ai@latest        # ou bun/pnpm/yarn
scoop install eternity-code             # Windows
choco install eternity-code             # Windows
brew install anomalyco/tap/eternity-code # macOS et Linux (recommandé, toujours à jour)
brew install eternity-code              # macOS et Linux (formule officielle brew, mise à jour moins fréquente)
sudo pacman -S eternity-code            # Arch Linux (Stable)
paru -S eternity-code-bin               # Arch Linux (Latest from AUR)
mise use -g eternity-code               # n'importe quel OS
nix run nixpkgs#eternity-code           # ou github:anomalyco/eternity-code pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/eternity-code/releases) ou [eternity-code.ai/download](https://eternity-code.ai/download).
...
4. `$HOME/.eternity-code/bin` - Repli par défaut
...
En savoir plus sur les [agents](https://eternity-code.ai/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'OpenCode, [**consultez notre documentation**](https://eternity-code.ai/docs).
...
Si vous travaillez sur un projet lié à OpenCode et que vous utilisez "eternity-code" dans le nom du projet (par exemple, "eternity-code-dashboard" ou "eternity-code-mobile"), ajoutez une note dans votre README pour préciser qu'il n'est pas construit par l'équipe OpenCode et qu'il n'est pas affilié à nous.
...
**Rejoignez notre communauté** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
