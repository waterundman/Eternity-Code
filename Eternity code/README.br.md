...
brew install anomalyco/tap/eternity-code # macOS e Linux (recomendado, sempre atualizado)
brew install eternity-code              # macOS e Linux (fórmula oficial do brew, atualiza menos)
sudo pacman -S eternity-code            # Arch Linux (Stable)
paru -S eternity-code-bin               # Arch Linux (Latest from AUR)
mise use -g eternity-code               # qualquer sistema
nix run nixpkgs#eternity-code           # ou github:anomalyco/eternity-code para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/eternity-code/releases) ou em [eternity-code.ai/download](https://eternity-code.ai/download).
...
4. `$HOME/.eternity-code/bin` - Fallback padrão
...
Saiba mais sobre [agents](https://eternity-code.ai/docs/agents).

### Documentação

Para mais informações sobre como configurar o OpenCode, [**veja nossa documentação**](https://eternity-code.ai/docs).
...
Se você estiver trabalhando em um projeto relacionado ao OpenCode e estiver usando "eternity-code" como parte do nome (por exemplo, "eternity-code-dashboard" ou "eternity-code-mobile"), adicione uma nota no README para deixar claro que não foi construído pela equipe do OpenCode e não é afiliado a nós de nenhuma forma.
...
**Junte-se à nossa comunidade** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
