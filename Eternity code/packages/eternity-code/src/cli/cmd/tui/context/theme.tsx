...
import opencode from "./theme/eternity-code.json" with { type: "json" }
...
function resolveTheme(theme: ThemeJson | undefined | null, mode: "dark" | "light"): Theme {
  if (!theme || !theme.theme) {
    // Fallback to default theme colors
    const bg = RGBA.fromHex("#0a0a0a")
    return {
      ...
      backgroundMenu: RGBA.fromHex("#1e1e1e"),
      border: RGBA.fromHex("#484848"),
      borderActive: RGBA.fromHex("#606060"),
      borderSubtle: RGBA.fromHex("#3c3c3c"),
      diffAdded: RGBA.fromHex("#4fd6be"),
      diffRemoved: RGBA.fromHex("#c53b53"),
      diffContext: RGBA.fromHex("#828bb8"),
      diffHunkHeader: RGBA.fromHex("#828bb8"),
      diffHighlightAdded: RGBA.fromHex("#b8db87"),
      diffHighlightRemoved: RGBA.fromHex("#e26a75"),
      diffAddedBg: RGBA.fromHex("#20303b"),
      diffRemovedBg: RGBA.fromHex("#37222c"),
      diffContextBg: RGBA.fromHex("#141414"),
      diffLineNumber: RGBA.fromHex("#1e1e1e"),
      diffAddedLineNumberBg: RGBA.fromHex("#1b2b34"),
      diffRemovedLineNumberBg: RGBA.fromHex("#2d1f26"),
      markdownText: RGBA.fromHex("#eeeeee"),
      markdownHeading: RGBA.fromHex("#9d7cd8"),
      markdownLink: RGBA.fromHex("#fab283"),
      markdownLinkText: RGBA.fromHex("#56b6c2"),
      markdownCode: RGBA.fromHex("#7fd88f"),
      markdownBlockQuote: RGBA.fromHex("#e5c07b"),
      markdownEmph: RGBA.fromHex("#e5c07b"),
      markdownStrong: RGBA.fromHex("#f5a742"),
      markdownHorizontalRule: RGBA.fromHex("#808080"),
      markdownListItem: RGBA.fromHex("#fab283"),
      markdownListEnumeration: RGBA.fromHex("#56b6c2"),
      markdownImage: RGBA.fromHex("#fab283"),
      markdownImageText: RGBA.fromHex("#56b6c2"),
      markdownCodeBlock: RGBA.fromHex("#eeeeee"),
      ...
      syntaxPunctuation: RGBA.fromHex("#eeeeee"),
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    const [store, setStore] = createStore({
      ...
      active: (config.theme ?? kv.get("theme", "eternity-code")) as string,
      ready: false,
    })
    ...
    const values = createMemo(() => {
      return resolveTheme(store.themes[store.active] ?? store.themes["eternity-code"], store.mode)
    })
