...
npm i -g eternity-code-ai@latest        # o bun/pnpm/yarn
scoop install eternity-code             # Windows
choco install eternity-code             # Windows
brew install anomalyco/tap/eternity-code # macOS y Linux (recomendado, siempre al día)
brew install eternity-code              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S eternity-code            # Arch Linux (Stable)
paru -S eternity-code-bin               # Arch Linux (Latest from AUR)
mise use -g eternity-code               # cualquier sistema
nix run nixpkgs#eternity-code           # o github:anomalyco/eternity-code para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/eternity-code/releases) o desde [eternity-code.ai/download](https://eternity-code.ai/download).
...
4. `$HOME/.eternity-code/bin` - Alternativa por defecto
...
Más información sobre [agents](https://eternity-code.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar OpenCode, [**ve a nuestra documentación**](https://eternity-code.ai/docs).
...
Si estás trabajando en un proyecto relacionado con OpenCode y usas "eternity-code" como parte del nombre; por ejemplo, "eternity-code-dashboard" u "eternity-code-mobile", agrega una nota en tu README para aclarar que no está construido por el equipo de OpenCode y que no está afiliado con nosotros de ninguna manera.
...
**Únete a nuestra comunidad** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
