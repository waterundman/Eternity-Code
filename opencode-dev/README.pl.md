...
# Menedżery pakietów
npm i -g eternity-code-ai@latest        # albo bun/pnpm/yarn
scoop install eternity-code             # Windows
choco install eternity-code             # Windows
brew install anomalyco/tap/eternity-code # macOS i Linux (polecane, zawsze aktualne)
brew install eternity-code              # macOS i Linux (oficjalna formuła brew, rzadziej aktualizowana)
sudo pacman -S eternity-code            # Arch Linux (Stable)
paru -S eternity-code-bin               # Arch Linux (Latest from AUR)
mise use -g eternity-code               # dowolny system
nix run nixpkgs#eternity-code           # lub github:anomalyco/eternity-code dla najnowszej gałęzi dev
```
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/eternity-code/releases) lub z [eternity-code.ai/download](https://eternity-code.ai/download).
...
4. `$HOME/.eternity-code/bin` - Domyślny fallback
...
Dowiedz się więcej o [agents](https://eternity-code.ai/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji OpenCode znajdziesz w [**dokumentacji**](https://eternity-code.ai/docs).
...
Jeśli pracujesz nad projektem związanym z OpenCode i używasz "eternity-code" jako części nazwy (na przykład "eternity-code-dashboard" lub "eternity-code-mobile"), dodaj proszę notatkę do swojego README, aby wyjaśnić, że projekt nie jest tworzony przez zespół OpenCode i nie jest z nami w żaden sposób powiązany.
...
- 100% open source
- Niezależne od dostawcy. Chociaż polecamy modele oferowane przez [OpenCode Zen](https://eternity-code.ai/zen); OpenCode może być używany z Claude, OpenAI, Google, a nawet z modelami lokalnymi. W miarę jak modele ewoluują, różnice będą się zmniejszać, a ceny spadać, więc ważna jest niezależność od dostawcy.
...
**Dołącz do naszej społeczności** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
