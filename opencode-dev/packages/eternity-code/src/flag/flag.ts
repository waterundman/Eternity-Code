...
export namespace Flag {
  ...
  export const ETERNITY_CODE_SERVER_USERNAME = process.env["ETERNITY_CODE_SERVER_USERNAME"]
  ...
  export const OPENCODE_EXPERIMENTAL_WORKSPACES = !falsy("OPENCODE_EXPERIMENTAL_WORKSPACES")
