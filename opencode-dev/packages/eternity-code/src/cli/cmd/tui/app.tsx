...
import { MetaDesignProvider } from "@tui/context/metadesign"
import { Home } from "@tui/routes/home"
import { Session } from "@tui/routes/session"
import { Loop } from "@tui/routes/loop"
...
function App() {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("Eternity Code")
      return
    }
  ...
  command.register(() => [
    ...
    },
    {
      ...
      value: "docs.open",
      onSelect: () => {
        open("https://eternity-code.ai/docs").catch(() => {})
        dialog.clear()
      },
      category: "System",
    },
  ...
  sdk.event.on(Installation.Event.UpdateAvailable.type, (evt) => {
    toast.show({
      ...
      message: `Eternity Code v${evt.properties.version} is available. Run 'eternity-code upgrade' to update manually.`,
      duration: 10000,
    })
  })
  ...
  return (
    ...
    >
      <Switch>
        ...
        <Match when={route.data.type === "loop"}>
          <Loop />
        </Match>
      </Switch>
    </box>
...
function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/eternity-code/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("eternity-code-version", Installation.VERSION)
