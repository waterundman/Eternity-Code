...
# Paketmanager
npm i -g eternity-code-ai@latest        # oder bun/pnpm/yarn
scoop install eternity-code             # Windows
choco install eternity-code             # Windows
brew install anomalyco/tap/eternity-code # macOS und Linux (empfohlen, immer aktuell)
brew install eternity-code              # macOS und Linux (offizielle Brew-Formula, seltener aktualisiert)
sudo pacman -S eternity-code            # Arch Linux (Stable)
paru -S eternity-code-bin               # Arch Linux (Latest from AUR)
mise use -g eternity-code               # jedes Betriebssystem
nix run nixpkgs#eternity-code           # oder github:anomalyco/eternity-code für den neuesten dev-Branch
```
...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/anomalyco/eternity-code/releases) oder [eternity-code.ai/download](https://eternity-code.ai/download) herunter.
...
Mehr dazu unter [Agents](https://eternity-code.ai/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von OpenCode findest du in unseren [**Docs**](https://eternity-code.ai/docs).
...
Wenn du an einem Projekt arbeitest, das mit OpenCode zusammenhängt und "eternity-code" als Teil seines Namens verwendet (z.B. "eternity-code-dashboard" oder "eternity-code-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom OpenCode-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.
...
**Tritt unserer Community bei** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
