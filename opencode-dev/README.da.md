...
brew install anomalyco/tap/eternity-code # macOS og Linux (anbefalet, altid up to date)
brew install eternity-code              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/eternity-code/releases) eller [eternity-code.ai/download](https://eternity-code.ai/download).
...
Læs mere om [agents](https://eternity-code.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af OpenCode, [**se vores docs**](https://eternity-code.ai/docs).
...
Hvis du arbejder på et projekt der er relateret til OpenCode og bruger "eternity-code" som en del af navnet; f.eks. "eternity-code-dashboard" eller "eternity-code-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af OpenCode-teamet og ikke er tilknyttet os på nogen måde.
...
- 100% open source
- Ikke låst til en udbyder. Selvom vi anbefaler modellerne via [OpenCode Zen](https://eternity-code.ai/zen); kan OpenCode bruges med Claude, OpenAI, Google eller endda lokale modeller. Efterhånden som modeller udvikler sig vil forskellene mindskes og priserne falde, så det er vigtigt at være provider-agnostic.
...
**Bliv en del af vores community** [Discord](https://discord.gg/eternity-code) | [X.com](https://x.com/eternity-code)
